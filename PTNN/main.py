...
data_path = "C:/Users/dell/Desktop/gsf_fcc_cut"
...
data_features_path = "C:/Users/dell/Desktop/features_fcc_cut.txt"
...
for i,hyper_para in enumerate(configs[para_name]):
    for k in range(configs['iter_time']):
        ...
        path = 'D:/' +'crss_models_fcc_cut1/'+'crss-fcc-cut-'+str(i)+'-'+str(k)+'.pth'
...
pre_text = 'crss_fcc_cut_1_' + para_name
